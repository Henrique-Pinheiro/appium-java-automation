...
Funcionalidade: Auto cadastro
  ...
  @PfCc
    Exemplos:
      ...
      | migrado       | 0123456789 | PF          | 237   | CC         | 03129   | 000883027 | 4      |
      | migrado       | 0123456789 | PF          | 237   | CC         | 06471   | 001781314 | 5      |
  @PfCp
    Exemplos:
      | tipo_cadastro | EC | tipo_pessoa | banco | tipo_conta | agencia | n_conta | digito |
  ...
  @PjCc
    Exemplos:
      | tipo_cadastro | EC         | tipo_pessoa | banco | tipo_conta | agencia | n_conta   | digito |
      | migrado       | 0123456789 | PJ          | 237   | CC         | 02345   | 103905949 | 1      |
      | migrado       | 0123456789 | PJ          | 237   | CC         | 02345   | 103905950 | 5      |
      | migrado       | 0123456789 | PJ          | 237   | CC         | 02345   | 103905951 | 3      |
  ...
  Esquema do Cenário: Cadastro de usuário com cartão pré-pago
    ...
    Exemplos:
      ...
      | migrado   | 0123456789 | 012345678934564 |
      | migrado   | 0123456789 | 012345678934565 |